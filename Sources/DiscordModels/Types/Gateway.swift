...
public struct Gateway: Sendable, Codable {
    ...
    public struct ThreadListSync: Sendable, Codable {
        public var guild_id: Snowflake<Guild>
        public var channel_ids: [Snowflake<DiscordChannel>]?
    ...
    public struct ThreadMembersUpdate: Sendable, Codable {
        ...
        public var removed_member_ids: [Snowflake<DiscordUser>]?
    }
    ...
    public struct RequestGuildMembers: Sendable, Codable {
        ...
        public init(guild_id: Snowflake<Guild>, query: String = "", limit: Int = 0, presences: Bool? = nil, user_ids: [String]? = nil, nonce: String? = nil) {
    ...
    public struct MessageDeleteBulk : Sendable, Codable {
        public var ids: [Snowflake<DiscordChannel.Message>]
        public var channel_id: Snowflake<DiscordChannel>
        public var guild_id: Snowflake<Guild>?
    }
